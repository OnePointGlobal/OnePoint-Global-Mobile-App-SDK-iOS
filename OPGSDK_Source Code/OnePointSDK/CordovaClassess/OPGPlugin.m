...
- (OPGPlugin*)initWithWebView:(UIWebView*)theWebView settings:(NSDictionary*)classSettings
{
...
- (NSString*)success:(OPGPluginResult*)pluginResult callbackId:(NSString*)callbackId
{
    [self.commandDelegate evalJs:[pluginResult toSuccessCallbackString:callbackId]];
    return @"";
}

- (NSString*)error:(OPGPluginResult*)pluginResult callbackId:(NSString*)callbackId
{
