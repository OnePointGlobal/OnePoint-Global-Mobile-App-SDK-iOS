...
static OPGWhitelist* gWhitelist = nil;
...
static OPGBaseController *viewControllerForRequest(NSURLRequest* request)
{
    ...
    return (__bridge OPGBaseController*)(void*)viewControllerAddress;
}

@implementation OPGURLProtocol
...
+ (void)registerViewController:(OPGBaseController*)viewController
{
    if (gRegisteredControllers == nil) {
        [NSURLProtocol registerClass:[OPGURLProtocol class]];
...
+ (BOOL)canInitWithRequest:(NSURLRequest*)theRequest
{
    ...
    OPGBaseController* viewController = viewControllerForRequest(theRequest);
