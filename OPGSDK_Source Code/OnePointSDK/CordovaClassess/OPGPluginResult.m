...
@interface OPGPluginResult ()

- (OPGPluginResult*)initWithStatus:(CDVCommandStatus)statusOrdinal message:(id)theMessage;

@end

@implementation OPGPluginResult
...
- (NSString*)argumentsAsJSON
{
    ...
    NSString* argumentsJSON = [argumentsWrappedInArray opg_JSONString];
