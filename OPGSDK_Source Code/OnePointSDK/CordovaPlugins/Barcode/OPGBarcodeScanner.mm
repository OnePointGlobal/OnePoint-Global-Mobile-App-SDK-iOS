...
#import "NSString+OPGSBJSON.h"#import <UIKit/UIKit.h>
...
//------------------------------------------------------------------------------
@protocol OPGBarcodeScannerOrientationDelegate <NSObject>
...
//------------------------------------------------------------------------------
@class OPGbcsProcessor;
@class OPGbcsViewController;

//------------------------------------------------------------------------------
// plugin class
//------------------------------------------------------------------------------
@interface OPGBarcodeScanner : OPGPlugin {
    NSString *callBackID;
}
- (NSString*)isScanNotPossible;
- (void)scan:(OPGInvokedUrlCommand*)command;
- (void)encode:(OPGInvokedUrlCommand*)command;
...
//------------------------------------------------------------------------------
@interface OPGbcsProcessor : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate> {}
@property (nonatomic, retain) OPGBarcodeScanner*           plugin;
@property (nonatomic, retain) NSString*                   callback;
@property (nonatomic, retain) UIViewController*           parentViewController;
@property (nonatomic, retain) OPGbcsViewController*        viewController;
...
- (id)initWithPlugin:(OPGBarcodeScanner*)plugin callback:(NSString*)callback parentViewController:(UIViewController*)parentViewController alterateOverlayXib:(NSString *)alternateXib;
- (void)scanBarcode;
...
//------------------------------------------------------------------------------
@interface OPGqrProcessor: NSObject
@property (nonatomic, retain) OPGBarcodeScanner*          plugin;
@property (nonatomic, retain) NSString*                   callback;
@property (nonatomic, retain) NSString*                   stringToEncode;
@property                     NSInteger                   size;

- (id)initWithPlugin:(OPGBarcodeScanner*)plugin callback:(NSString*)callback stringToEncode:(NSString*)stringToEncode;
- (void)generateImage;
@end
...
//------------------------------------------------------------------------------
@interface OPGbcsViewController : UIViewController <OPGBarcodeScannerOrientationDelegate> {}
@property (nonatomic, retain) OPGbcsProcessor*  processor;
@property (nonatomic, retain) NSString*        alternateXib;
...
- (id)initWithProcessor:(OPGbcsProcessor*)processor alternateOverlay:(NSString *)alternateXib;
- (void)startCapturing;
...
// plugin class
//------------------------------------------------------------------------------
@implementation OPGBarcodeScanner
...
- (void)scan:(OPGInvokedUrlCommand*)command {
    ...
    processor = [[OPGbcsProcessor alloc]
                 initWithPlugin:self
                 callback:callback
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    if (buttonIndex == 0) {
        [self returnError:@"No access to camera" callback:callBackID];
    }
    // Dismiss the view
}
...
- (void)encode:(OPGInvokedUrlCommand*)command {
    ...
    OPGqrProcessor* processor;
    NSString*       callback;
    callback = command.callbackId;
    
    processor = [[OPGqrProcessor alloc]
                 initWithPlugin:self
                 callback:callback
...
- (void)returnImage:(NSString*)filePath format:(NSString*)format callback:(NSString*)callback{
    ...
    OPGPluginResult* result = [OPGPluginResult
...
// class that does the grunt work
//------------------------------------------------------------------------------
@implementation OPGbcsProcessor
...
//--------------------------------------------------------------------------
- (id)initWithPlugin:(OPGBarcodeScanner*)plugin
...
parentViewController:(UIViewController*)parentViewController
  alterateOverlayXib:(NSString *)alternateXib {
    ...
    CFURLRef soundFileURLRef  = CFBundleCopyResourceURL(CFBundleGetMainBundle(), CFSTR("OPGBarcodeScanner.bundle/beep"), CFSTR ("caf"), NULL);
...
//    self.previewLayer = nil;
    ...
    self.viewController = [[OPGbcsViewController alloc] initWithProcessor: self alternateOverlay:self.alternateXib];
...
// view controller for the ui
//------------------------------------------------------------------------------
@implementation OPGbcsViewController
...
#pragma mark OPGBarcodeScannerOrientationDelegate
